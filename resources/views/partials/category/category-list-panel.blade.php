...
<div class="row g-3">
    @foreach($categorys as $category)
        @include('partials.category.window-confirm-category',array("category"=>$category))
        <div class="col-sm-3">
            <div id="items-list-panel" class="card">
                <div class="card-header">
                    <div>{{$category->name}}</div>
                    <a type="button" data-bs-toggle="modal" data-bs-target="#categoryConfirmModal{{ $category->id }}">
